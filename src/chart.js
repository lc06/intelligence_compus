...
const subjectsName = ['工学', '理学', '管理学', '文学', '经济学', '教育学', '艺术学', '法学'];
const subjectsMajor = [37, 8, 7, 4, 2, 2, 2, 1];
const salvSubMax =[];//背景按最大值

for (let i = 0; i < subjectsMajor.length; i++) {
    salvSubMax.push(subjectsMajor[0])
}
...
const data = [];
const color3 = ['#00FFFF', "#C424FF", '#ffa800', '#ff5b00', '#ff3000'];
